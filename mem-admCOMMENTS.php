...
{
	if($level=='1')
		$level = "<img src='feature/profile/img/badges/level/admin2.png' width='150' height='50'>";
	else
		$level = "<img src='feature/profile/img/badges/level/student2.png' width='150' height='50'>";
	return $level;
}
...
<div id="menu">
<pre><a href="mem-admCOMMENTS.php"class="current_page_item">COMMENT</a>   <a href="mem-admBIODATA.php">BIODATA</a>   <a href="mem-admSETTINGS.php">SETTINGS</a>  <?php if($level=='1')
...
<div id="sidebar">
  ...
  <h3>&nbsp;</h3>
    <h3>&nbsp;</h3>
<a href=""><img src="images/98d7044a7a374a2cd0540f4852db38b9.png" width="239" height="237"></a>
<h3>&nbsp;</h3>
<h3>&nbsp;</h3>
<h3>&nbsp;</h3>
</div>
...
<div id="main">
	...
	<table width="600" height="650px" align="left" cellpadding="20%" class="m_container" name="m_container">
		<tr>
        <td width="880">
<table name="s_container" class="s_container" align="left" >
                	<tr align="left" class="head_content">
                    	
                        
                      <!-- Badge -->
                      <td colspan="4" class="badge">
					  <?php print checkLevel($level); ?></td>
</tr>
                    <tr class="head_content">
                    	<td colspan="4" align="left" class="nim"><?php print $username; ?></td>
                    </tr>
                    <tr class="head_content">
                    	<!-- Name -->
                    	<td colspan="4" align="left" class="name"><?php print $name; ?></td>
                    </tr>
          </table>
              </br>
          <p>
...
?>
          ...
          <form action="feature/profile/update/addcomment.php" method="post">
          <table border="0" name="m_container" class="m_container" align="center" width="500">
    	<tr>
        	<td>
            	<table border="0" name="s_container" class="s_container" width="545">
                	<tr>
                    	<th class="header" colspan="0"><h2><strong>Comments</strong></h2></th>
                    </tr>
                    <tr>
                   	  <td class="field" colspan="2"><textarea name="comment" class="comment" id="comment" style="width:545px; height:100px;"></textarea></td>
                    </tr>
                    <tr>
                    	<td width="500" class="editor">Logged As : <?php print $name; ?></td>
                        <td width="56"><input type="submit" name="Submit" value="Submit" onclick="return check();"></td>
                    </tr>
                    <tr>
                    	<td colspan="0"><strong>Show Comment</strong></td>
                    </tr>
                    <tr>
                    	<td colspan="2"><iframe class="frame_comment" width="545" height="200px" src="feature/profile/show_comment.php"></iframe></td>
                    </tr>
                </table>
          </td>
        </tr>
